...
export const Header = ({ data }: { data: GlobalHeader }) => {
  ...
  const activeItemClasses = {
    ...
    yellow:
      "border-b-3 border-gray-900 text-gray-1000 font-extrabold dark:text-white-300 font-medium dark:border-yellow-600",
  };
  ...
  return (
    <div className={`relative overflow-hidden ${headerColorCss}`}>
